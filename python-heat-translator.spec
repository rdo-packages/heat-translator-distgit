...
# this was submited upstream but they pulled it back out
# not sure why they don't include these files in the setup.py install
sed -i '/setup_requires/a\    include_package_data = True,' setup.py
sed -i '/include_package_data/a\    package_data={"translator": ["conf/*.conf"]},' setup.py
