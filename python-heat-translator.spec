...
Requires:   python-python-heatclient
Requires:   python-python-glanceclient
...
# remove some utils tests that don't work in jenkins
sed -i -e '/test_yamlutils_compare_yamls/,/^$/d' translator/tests/test_utils.py
sed -i -e '/test_yamlutils_get_dict_missing_file/,/^$/d' translator/tests/test_utils.py
sed -i -e '/test_yamlutils_get_dict/,/^$/d' translator/tests/test_utils.py
