...
%install
%{pyver_install}
mv %{buildroot}%{_bindir}/%{executable} %{buildroot}%{_bindir}/%{executable}-%{python_version}
ln -s ./%{executable}-%{python_version} %{buildroot}%{_bindir}/%{executable}-%{pyver}
ln -s ./%{executable}-%{python_version} %{buildroot}%{_bindir}/%{executable}
...
%{_bindir}/%{executable}-%{python_version}
